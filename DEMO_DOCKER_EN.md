...
```
Step #28 indicates successful verification.

### **28.1 - Alice's response - credential generated by Health Institute:**  
...
### **29 - After verification, the Immunization Center operator can generate a new credential for Alice by selecting option 1.**
```bash
...
### **30 - After the verification and issuance of the new credential, check in Alice's agent that it has been received:** 
```bash
